...
function Store(options) {
  ...
  this.stringify = options.stringify || Store.JSONStringify;
  this.parse = options.parse || Store.JSONParse;
}
Store.JSONStringify = function (val) {
  return JSON.stringify(val, null, 2);
};
Store.JSONParse = function (val) {
